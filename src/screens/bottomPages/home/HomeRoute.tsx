...
const firstSlider: Array<ISlider> = [
  {
    season: 'New Season',
    brand: 'Heritage',
    price: '$335.00',
    ...
    <ScrollView contentContainerStyle={{backgroundColor: 'white'}}>
      <View style={styles.bodyHome}>
        <View style={styles.logo}>
          ...
          <RNButton
            title="Explore More"
            onPress={() => console.log('explore more in home page')}
          />
        </View>
        <View style={styles.logo}>
          <View style={styles.textView}>
          ...
          <RNButton onPress={() => console.log(' from home page')} />
        </View>
        ...
        <View style={styles.logo}>
          ...
          <View style={{flex: 1, marginBottom: 25}}>
            <Slider height={windowHeight / 4} sliderData={secondSlider} />
            {/* carpet.jpg')*/}
          </View>
          <RNButton onPress={() => console.log(' from home page')} />
        </View>
        ...
        <View style={styles.logo}>
          ...
          <View style={{flex: 1, marginBottom: 25}}>
            <Slider height={windowHeight / 4} sliderData={firstSlider} />
            {/* slider4.jpg */}
          </View>
          <RNButton onPress={() => console.log(' from home page')} />
